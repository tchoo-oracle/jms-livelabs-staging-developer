...
2. Create IPSec Connection
    ...
    * Alternatively, you can use **CPE Configuration Helper** to create **Configuration Output** .
...
9. Check the status of ipsec service.
    ...
    If the status is `inactive` or `failed` please follow the [Site-to-Site VPN Troubleshooting](https://docs.oracle.com/en-us/iaas/Content/Network/Troubleshoot/ipsectroubleshoot.htm).
